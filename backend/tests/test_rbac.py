...
class TestAdminLogin:
    ...
    def test_admin_can_access_trainer_courses(self):
        ...
        print(f"SUCCESS: Admin can access /api/trainer/courses - found {len(data)} courses")
...
class TestTrainerLogin:
    ...
    def test_trainer_can_access_trainer_courses(self):
        ...
        data = response.json()
        assert isinstance(data, list)
        print(f"SUCCESS: Trainer can access /api/trainer/courses - found {len(data)} courses")
...
class TestLearnerSignupAndAccess:
    ...
    def test_learner_can_access_public_courses(self):
        ...
        data = response.json()
        assert isinstance(data, list)
        print(f"SUCCESS: Learner can access public /api/courses - found {len(data)} courses")
...
class TestUnauthenticatedAccess:
    ...
    def test_unauthenticated_cannot_access_trainer_courses(self):
        ...
        assert response.status_code == 401
        print(f"SUCCESS: Unauthenticated user denied access to /api/trainer/courses (401)")

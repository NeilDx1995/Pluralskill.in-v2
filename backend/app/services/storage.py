...
class StorageService:
    def __init__(self, upload_dir: Path):
        ...
        # Ensure local directories exist regardless of S3 (for fallbacks or hybrids)
        ...
        (self.upload_dir / "assignments").mkdir(exist_ok=True)
    ...
    async def upload_file(self, file: UploadFile, directory: str) -> dict:
        ...
        if self.s3_client:
            ...
            return self._upload_to_local(file, directory, unique_name, size, content_type)

    def _upload_to_local(self, file: UploadFile, directory: str, unique_name: str, size: int, content_type: str) -> dict:
    ...
    def _upload_to_s3(self, file: UploadFile, directory: str, unique_name: str, size: int, content_type: str) -> dict:
